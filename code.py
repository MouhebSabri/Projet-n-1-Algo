...
for bit in compressed_text:
    print(bin(bit)[2:].zfill(8), end=' ')
# représentation binaire de chaque entier dans compressed_text sous forme d'une séquence de chaînes binaires
bytes_data = bytes(text, 'utf-8')
with open('compressed_text.bin', 'wb') as file_comp:
